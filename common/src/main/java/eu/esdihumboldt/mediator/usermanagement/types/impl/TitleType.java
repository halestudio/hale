...
public class TitleType implements java.io.Serializable {
    ...
    /**
     * Method valueOf.Returns a new TitleType based on the given
     * String value.
     * 
     * @param string
     * @return the TitleType value of parameter 'string'
     */
    public static eu.esdihumboldt.mediator.usermanagement.types.impl.TitleType valueOf(
