...
import eu.esdihumboldt.mediator.usermanagement.PersonProfile;
 ...
 */
public abstract class PersonProfileType implements java.io.Serializable, PersonProfile {
     ...
     * Field _title.
     */
    private eu.esdihumboldt.mediator.usermanagement.types.impl.TitleType title;

    /**
     * Field _academicTitle.
     */
    private eu.esdihumboldt.mediator.usermanagement.types.impl.AcademicTitleType academicTitle;
    ...
    /**
     * This element contains any free-form text
     *  pertinent to the PersonProfile. This element may
     *  contain notes or any other similar information
     *  that is not contained explicitly in another
     *  structure.
     *  
     */
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.types.impl.AcademicTitleType getAcademicTitle(
    ) {
    ...
    /**
     * Returns the value of field 'generalNotes'. The field
     * 'generalNotes' has the following description: This element
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.types.impl.TitleType getTitle(
    ) {
        return this.title;
    }
     ...
     * 
     * @param academicTitle the value of field 'academicTitle'.
     */
    public void setAcademicTitle(
            final eu.esdihumboldt.mediator.usermanagement.types.impl.AcademicTitleType academicTitle) {
    ...
    /**
     * Sets the value of field 'generalNotes'. The field
     * 'generalNotes' has the following description: This element
     * contains any free-form text
     *  pertinent to the PersonProfile. This element may
     *  contain notes or any other similar information
     ...
     * 
     * @param personalAddress the value of field 'personalAddress'.
     */
    ...
    public void setTitle(
            final eu.esdihumboldt.mediator.usermanagement.types.impl.TitleType title) {
        this.title = title;
    }
