...
import eu.esdihumboldt.mediator.usermanagement.Address;
...
public abstract class AddressType implements java.io.Serializable,Address {
     ...
     * Field _countryCode.
     */
    private eu.esdihumboldt.mediator.usermanagement.types.impl.CountryCodeType countryCode;
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.types.impl.CountryCodeType getCountryCode(
    ) {
    ...
    public void setCountryCode(
            final eu.esdihumboldt.mediator.usermanagement.types.impl.CountryCodeType countryCode) {
