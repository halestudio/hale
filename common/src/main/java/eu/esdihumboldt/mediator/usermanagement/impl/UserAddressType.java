...
import eu.esdihumboldt.mediator.usermanagement.UserAddress;
import eu.esdihumboldt.mediator.usermanagement.Address.CountryCode;
import eu.esdihumboldt.mediator.usermanagement.UserAddress.CommunicationDetail;
 ...
 */
public abstract class UserAddressType extends eu.esdihumboldt.mediator.usermanagement.impl.AddressType 
implements java.io.Serializable, UserAddress
{
    ...
    public void addCommunicationDetails(
            final eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl vCommunicationDetails)
     ...
     * eu.esdihumboldt.mediator.usermanagement.CommunicationDetails
     * at the given index
     */
    public eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl getCommunicationDetails(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.communicationDetailsList.size()) {
            throw new IndexOutOfBoundsException("getCommunicationDetails: Index value '" + index + "' not in range [0.." + (this.communicationDetailsList.size() - 1) + "]");
        }
        
        return (eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl) communicationDetailsList.get(index);
    }

    /**
     * Method getCommunicationDetails.Returns the contents of the
    ...
    public eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl[] getCommunicationDetails(
        ...
        eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl[] array = new eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl[0];
        return (eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl[]) this.communicationDetailsList.toArray(array);
    }
    ...
    public boolean removeCommunicationDetails(
            final eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl vCommunicationDetails) {
        boolean removed = communicationDetailsList.remove(vCommunicationDetails);
        return removed;
    }
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl removeCommunicationDetailsAt(
            final int index) {
        java.lang.Object obj = this.communicationDetailsList.remove(index);
        return (eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl) obj;
    }
    ...
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.communicationDetailsList.size()) {
            throw new IndexOutOfBoundsException("setCommunicationDetails: Index value '" + index + "' not in range [0.." + (this.communicationDetailsList.size() - 1) + "]");
        }
     ...
     */
    public void setCommunicationDetails(
            final eu.esdihumboldt.mediator.usermanagement.impl.CommunicationDetailsImpl[] vCommunicationDetailsArray) {
        //-- copy array
     ...
     * 
     * @param floor the value of field 'floor'.
     */
    public void setFloor(
            final java.lang.String floor) {
        this.floor = floor;
    }
     ...
     * 
     * @param inhousMail the value of field 'inhousMail'.
     */
    public void setInhouseMail(
            final java.lang.String inhouseMail) {
     ...
     * 
     * @param roomNumber the value of field 'roomNumber'.
     */
