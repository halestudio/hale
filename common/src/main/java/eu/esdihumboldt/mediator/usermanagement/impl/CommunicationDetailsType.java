...
/**
 * It contains the information regarding the communication
...
public abstract class CommunicationDetailsType implements java.io.Serializable {
     ...
     */
    private eu.esdihumboldt.mediator.usermanagement.impl.PersonCommunicationImpl _personCommunication;
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.impl.PersonCommunicationImpl getPersonCommunication(
    ) {
     ...
     * 
     * @return true if at least one DefaultCommunication has been
     * added
     */
     ...
     * 
     * @param communicationDetailDescription the value of field
     ...
     * 
     * @param communicationValue the value of field
     * 'communicationValue'.
     */
    public void setCommunicationValue(
            final java.lang.String communicationValue) {
     ...
     * 
     * @param defaultCommunication the value of field
     * 'defaultCommunication'.
     */
    public void setDefaultCommunication(
            final boolean defaultCommunication) {
     ...
     * 
     * @param personCommunication the value of field
     * 'personCommunication'.
     */
    public void setPersonCommunication(
            final eu.esdihumboldt.mediator.usermanagement.impl.PersonCommunicationImpl personCommunication) {
