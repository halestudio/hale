...
//		this.satisfied = true;
     ...
     * @param _serviceType serviceType to use.
     * @param _serviceVersion serviceVersion to use.
     */
    ...
    /**
     * Use this Constructor to specify a single Service as well as a
     * specific {@link ConstraintSource}.
     * @param _serviceType serviceType to use.
     * @param _serviceVersion serviceVersion to use.
     * @param _constraintSource the {@link ConstraintSource} that this
     * {@link ServiceConstraint} originates from.
     */
    public ServiceConstraintImpl(String _serviceType, String _serviceVersion, ConstraintSource _constraintSource){
        this.serviceType = _serviceType;
        this.serviceVersion = _serviceVersion;
    ...
    /**
     * @see eu.esdihumboldt.mediator.constraints.ServiceConstraint#getServiceType()
     */
    ...
    /**
     * @see eu.esdihumboldt.mediator.constraints.ServiceConstraint#getServiceVersion()
     */
    ...
    public boolean compatible(Constraint constraint){
        if(constraint != null || (constraint instanceof ServiceConstraint)){
            ...
            boolean isSameVersion = this.serviceVersion.equals(serviceConstraint.
            getServiceVersion());
