...
public class ObjectFactory {
    ...
    private final static QName _SimpleDataInput_QNAME = new QName("", "SimpleDataInput");
    private final static QName _Workflow_QNAME = new QName("", "Workflow");
    private final static QName _TransformerDataInput_QNAME = new QName("", "TransformerDataInput");
    private final static QName _DataInput_QNAME = new QName("", "DataInput");
    private final static QName _ComplexDataInput_QNAME = new QName("", "ComplexDataInput");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SimpleDataInput }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "SimpleDataInput")
    public JAXBElement<SimpleDataInput> createSimpleDataInput(SimpleDataInput value) {
        return new JAXBElement<SimpleDataInput>(_SimpleDataInput_QNAME, SimpleDataInput.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TransformerDataInput }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "TransformerDataInput")
    public JAXBElement<TransformerDataInput> createTransformerDataInput(TransformerDataInput value) {
        return new JAXBElement<TransformerDataInput>(_TransformerDataInput_QNAME, TransformerDataInput.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ComplexDataInput }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "ComplexDataInput")
    public JAXBElement<ComplexDataInput> createComplexDataInput(ComplexDataInput value) {
        return new JAXBElement<ComplexDataInput>(_ComplexDataInput_QNAME, ComplexDataInput.class, null, value);
    }
