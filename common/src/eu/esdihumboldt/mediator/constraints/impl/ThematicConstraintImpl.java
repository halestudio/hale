...
import eu.esdihumboldt.modelmapping.imm.impl.PrototypeInformationModel;
 ...
 * {@link Serializable}, as usual for a Constraint 
 * implementation.
 * 
...
//		this.satisfied = true;
     ...
     * @param _im the ConceptualSchema to use.
     */
    ...
    /**
     * @return
     * @see eu.esdihumboldt.mediator.constraints.ThematicConstraint#getThemes()
     */
