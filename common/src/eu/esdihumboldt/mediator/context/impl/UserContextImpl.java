...
import eu.esdihumboldt.mediator.context.DefaultContext;
import eu.esdihumboldt.mediator.context.OrganizationContext;
import eu.esdihumboldt.mediator.context.UserContext;
import eu.esdihumboldt.mediator.context.Context.ContextType;
...
public class UserContextImpl implements UserContext {
	...
	/**
	 * @see eu.esdihumboldt.mediator.context.UserContext#getParentContext()
	 */
	...
	/**
	 * @see eu.esdihumboldt.mediator.context.UserContext#getUser()
	 */
	public User getUser() {
		return this.user;
	}
	...
	/**
	 * @see eu.esdihumboldt.mediator.context.Context#getAllConstraints()
	 */
	...
	/**
	 * @see eu.esdihumboldt.mediator.context.Context#getAllConstraints(eu.esdihumboldt.mediator.context.Context.ContextType)
	 */
	 ...
	 * 
	 * @see eu.esdihumboldt.mediator.context.Context#getCombinedConstraints(eu.esdihumboldt.mediator.context.Context.ContextType)
	 */
	...
	/**
	 * @see eu.esdihumboldt.mediator.context.Context#getContextType()
	 */
