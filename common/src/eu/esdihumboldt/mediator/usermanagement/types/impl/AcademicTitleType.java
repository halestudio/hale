...
public class AcademicTitleType implements java.io.Serializable {
     ...
     */
    public static final AcademicTitleType PROF_ = new AcademicTitleType(PROF__TYPE, "Prof.");
     ...
     */
    public static final AcademicTitleType PH_D_ = new AcademicTitleType(PH_D__TYPE, "Ph.D.");
     ...
     */
    public static final AcademicTitleType MASTER = new AcademicTitleType(MASTER_TYPE, "Master");
     ...
     */
    public static final AcademicTitleType BACHELOR = new AcademicTitleType(BACHELOR_TYPE, "Bachelor");
     ...
     */
    public static final AcademicTitleType OTHER = new AcademicTitleType(OTHER_TYPE, "Other");
     ...
     * instances of AcademicTitleType
     * 
    ...
    /**
     * Method valueOf.Returns a new AcademicTitleType based on the
     * given String value.
     * 
     * @param string
     * @return the AcademicTitleType value of parameter 'string'
     */
    public static eu.esdihumboldt.mediator.usermanagement.types.impl.AcademicTitleType valueOf(
