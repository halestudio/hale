...
import eu.esdihumboldt.mediator.constraints.MetadataConstraint.MetadataType;
...
public class MetadataTypeFieldHandler extends GeneralizedFieldHandler {
	...
	public Object convertUponGet(Object metadataType) {	
		...
		return (metadataType == null) ? null : ((MetadataType) metadataType).toString();
	}
	...
	public Object convertUponSet(Object stringMetadataType) {
		return (stringMetadataType == null)? null : MetadataType.valueOf((String)stringMetadataType);
	}
