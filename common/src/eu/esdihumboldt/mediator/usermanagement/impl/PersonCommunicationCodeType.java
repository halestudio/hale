...
/**
 * This element is container to hold the coded list of the
 *  communication method of the person.
 *  
 * 
 * @version $Revision: 1.1 $ $Date: 2007-10-19 10:03:06 $
 */
public abstract class PersonCommunicationCodeType implements java.io.Serializable {
     ...
     */
    private eu.esdihumboldt.mediator.usermanagement.types.impl.PersonCommunicationTypeCodedType _personCommunicationTypeCoded;
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.types.impl.PersonCommunicationTypeCodedType getPersonCommunicationTypeCoded(
    ) {
     ...
     * 
     * @param personCommunicationTypeCoded the value of field
     * 'personCommunicationTypeCoded'.
     */
    public void setPersonCommunicationTypeCoded(
            final eu.esdihumboldt.mediator.usermanagement.types.impl.PersonCommunicationTypeCodedType personCommunicationTypeCoded) {
     ...
     * 
     * @param personCommunicationTypeCodedOther the value of field
     * 'personCommunicationTypeCodedOther'.
     */
