...
public abstract class AddressImpl implements java.io.Serializable {
     ...
     * Field _userAddress.
     */
    private eu.esdihumboldt.mediator.usermanagement.impl.UserAddressImpl _userAddress;

    /**
     * Field _organizationAddress.
     */
    private eu.esdihumboldt.mediator.usermanagement.OrganizationAddress _organizationAddress;
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.OrganizationAddress getOrganizationAddress(
    ) {
     ...
     */
    public eu.esdihumboldt.mediator.usermanagement.impl.UserAddressImpl getUserAddress(
    ) {
    ...
    public void setOrganizationAddress(
            final eu.esdihumboldt.mediator.usermanagement.OrganizationAddress organizationAddress) {
    ...
    public void setUserAddress(
            final eu.esdihumboldt.mediator.usermanagement.impl.UserAddressImpl userAddress) {
