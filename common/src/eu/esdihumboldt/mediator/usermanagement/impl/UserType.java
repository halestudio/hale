...
import eu.esdihumboldt.mediator.context.UserContext;
import eu.esdihumboldt.mediator.context.impl.UserContextImpl;
...
/**
 * This Type contains all elements required to specify the
 *  HUMBOLDT User.
 *  
 * 
...
public abstract class UserType implements java.io.Serializable,User {
    ...
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.contextList.size()) {
            throw new IndexOutOfBoundsException("setContext: Index value '" + index + "' not in range [0.." + (this.contextList.size() - 1) + "]");
        }
     ...
     * 
     * @param contextId the value of field 'contextId'.
     */
     ...
     * 
     * @param internalRole the value of field 'internalRole'.
     */
    public void setInternalRole(
            final InternalRoleImpl internalRole) {
     ...
     * 
     * @param personProfile the value of field 'personProfile'.
     */
    public void setPersonProfile(
            final PersonProfile personProfile) {
