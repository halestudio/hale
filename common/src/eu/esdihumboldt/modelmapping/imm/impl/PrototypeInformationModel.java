...
import eu.esdihumboldt.mediator.contextservice.hibernate.helpers.ResponsiblePartyHelper;
import eu.esdihumboldt.modelrepository.abstractfc.AccessConstraint;
...
import eu.esdihumboldt.modelrepository.abstractfc.VersionInformation;
...
public class PrototypeInformationModel 
	...
	private String name;
	private eu.esdihumboldt.mediator.contextservice.hibernate.helpers.CitationHelper dbName;
	
	private Citation parentIMcitation = null;
	
	private Set<eu.esdihumboldt.mediator.contextservice.hibernate.helpers.CitationHelper> dbParentIMcitation;
	 ...
	 * @return the dbName
	 */
	public eu.esdihumboldt.mediator.contextservice.hibernate.helpers.CitationHelper getDbName() {
		return dbName;
	}
	...
	public void setDbName(
			eu.esdihumboldt.mediator.contextservice.hibernate.helpers.CitationHelper dbName) {
		this.dbName = dbName;
	}
	 ...
	 */
	public Set<eu.esdihumboldt.mediator.contextservice.hibernate.helpers.CitationHelper> getDbParentIMcitation() {
	...
	public void setDbParentIMcitation(
			Set<eu.esdihumboldt.mediator.contextservice.hibernate.helpers.CitationHelper> dbParentIMcitation) {
