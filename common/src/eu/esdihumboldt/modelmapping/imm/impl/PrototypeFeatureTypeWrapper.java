...
public class PrototypeFeatureTypeWrapper {
	...
	/**
	 * @param wrapperdClass the wrapperdClass to set
	 */
	...
	private void setIdentifications(HashSet<IdentificationHelper> identifications){
		this.identifications = identifications;
		IdentificationHelper identification = (IdentificationHelper) identifications.toArray()[0];
