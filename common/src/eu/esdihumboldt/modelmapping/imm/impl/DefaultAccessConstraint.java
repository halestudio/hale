...
import eu.esdihumboldt.mediator.contextservice.hibernate.helpers.IdentifierHelper;
...
public class DefaultAccessConstraint 
	...
	/**
	 * @see eu.esdihumboldt.modelrepository.abstractfc.AccessConstraint#getAccessRightTypes()
	 */
	...
	/**
	 * @see eu.esdihumboldt.modelrepository.abstractfc.AccessConstraint#getPartyIdentifier()
	 */
	...
	/**
	 * @see eu.esdihumboldt.modelrepository.abstractfc.AccessConstraint#getUsageInformation()
	 */
