...
public class FilterTest {
	...
	/*	
		...
		*/
		...
		boolean foundIt5 = false;
				...
				Filter cqlfilter21 = new FilterGeoCqlImpl("\"id\" = '_00000000-7953-b57f-0000-00000010cb14'");

				Filter cqlfilter3 = new FilterGeoCqlImpl("\"geometry.Polygon.srsName\" = 'EPSG:4326'");
				Filter cqlfilter4 = new FilterGeoCqlImpl("\"geometry.{http://www.opengis.net/gml/3.2}Polygon.srsName\" = 'EPSG:4326'");
				Filter cqlfilter5 = new FilterGeoCqlImpl("\"{http://www.opengis.net/gml/3.2}geometry.Polygon.srsName\" = 'EPSG:4326'");
				...
				/*	if(cqlfilter4.match(inst)){
						foundIt4 = true;
					}
					if(cqlfilter5.match(inst)){
						foundIt5 = true;
					}*/
				}	
	...
	public void testLoadShiporderECQL() throws Exception {
		...
		boolean stayFalseToo = false;
			...
			//	Filter cqlfilter = new FilterGeoCqlImpl("{http://www.example.com}shipto.{http://www.example.com}city = '4000 Stavanger'");
