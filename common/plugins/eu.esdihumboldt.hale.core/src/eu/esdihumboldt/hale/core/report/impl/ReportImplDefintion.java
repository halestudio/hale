...
//		super(DefaultReporter.class, "default");
	...
	/**
	 * @see eu.esdihumboldt.hale.core.report.impl.AbstractReportDefinition#createReport(java.util.Properties)
	 */
	@Override
...
//		report.getWarnings().addAll(Arrays.asList(StringUtils.split(props.getProperty(KEY_REPORT_WARNINGS), ";"))); // TODO add a proper way of adding old warnings and stuff
	...
	/**
	 * @see eu.esdihumboldt.hale.core.report.impl.AbstractReportDefinition#asProperties(eu.esdihumboldt.hale.core.report.Report)
	 */
	@Override
