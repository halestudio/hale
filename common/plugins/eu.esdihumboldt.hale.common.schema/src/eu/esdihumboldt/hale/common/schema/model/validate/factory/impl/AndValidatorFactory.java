...
/**
 * Converts {@link AndValidator}s to {@link Value}s and vice versa.
 * 
 * @author Simon Templer
 */
public class AndValidatorFactory extends AbstractCombinedValidatorFactory<AndValidator> {

	@Override
	protected CombinedValidator createValidator(List<Validator> children) {
		return new AndValidator(children);
	}
