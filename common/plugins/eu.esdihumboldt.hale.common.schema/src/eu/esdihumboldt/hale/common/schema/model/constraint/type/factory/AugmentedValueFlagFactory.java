...
/**
 * Converts a {@link AugmentedValueFlag} to a {@link Value} and vice versa.
 * 
 * @author Simon Templer
 */
public class AugmentedValueFlagFactory extends FlagConstraintFactory<AugmentedValueFlag> {

	@Override
	protected AugmentedValueFlag restore(boolean enabled) {
		return AugmentedValueFlag.get(enabled);
	}
