 ...
 *         &lt;element name="export-config" type="{}ExportConfigurationType" maxOccurs="unbounded" minOccurs="0"/>
...
public class ProjectType {
    ...
    protected List<ExportConfigurationType> exportConfig;
     ...
     * 
     */
    public List<ExportConfigurationType> getExportConfig() {
        if (exportConfig == null) {
            exportConfig = new ArrayList<ExportConfigurationType>();
        }
