...
import eu.esdihumboldt.hale.common.align.model.functions.explanations.RetypeExplanation;
import eu.esdihumboldt.hale.common.core.service.ServiceProvider;

/**
 * Explanation for {@link GroovyRetype}
 * 
 * @author Simon Templer
 */
public class GroovyRetypeExplanation extends RetypeExplanation {

	@Override
	protected Class<?> getDefaultMessageClass() {
		return RetypeExplanation.class;
	}
