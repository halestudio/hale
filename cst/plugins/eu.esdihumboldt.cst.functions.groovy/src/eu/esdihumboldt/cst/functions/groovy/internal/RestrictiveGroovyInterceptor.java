...
public class RestrictiveGroovyInterceptor extends GroovyInterceptor {
	 ...
	 * missing may be used.
	 */
	private static final Set<Class<?>> allMethodsAllowedClasses = new HashSet<>();
	...
	static {
		...
		allMethodsAllowedClasses.add(InstanceBuilder.class);
		allMethodsAllowedClasses.add(InstanceAccessor.class);
	...
	private boolean checkMethodCall(Object receiver, String method) throws TransformationException {
		if (receiver instanceof Closure) {
			...
			return allMethodsAllowedClasses.contains(receiver.getClass())
