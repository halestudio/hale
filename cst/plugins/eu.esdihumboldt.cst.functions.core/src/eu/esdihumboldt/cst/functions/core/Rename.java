...
public class Rename extends AbstractSingleTargetPropertyTransformation<TransformationEngine> implements RenameFunction {
	...
	protected Object evaluate(String transformationIdentifier, TransformationEngine engine,
		...
		String structuralRename = "false";
		if (getParameters() != null && !getParameters().get(PARAMETER_STRUCTURAL_RENAME).isEmpty()) {
			structuralRename = getParameters().get(PARAMETER_STRUCTURAL_RENAME).get(0);
		}
