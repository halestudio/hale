...
abstract class TransformationExamples {
	...
	static {
		internalExamples[SIMPLE_RENAME] = defaultExample(SIMPLE_RENAME)
		internalExamples[CARD_RENAME] = defaultExample(CARD_RENAME)
		internalExamples[DUPE_ASSIGN] = defaultExample(DUPE_ASSIGN)
		internalExamples[PROPERTY_JOIN] = defaultExample(PROPERTY_JOIN)
		internalExamples[SIMPLE_MERGE] = defaultExample(SIMPLE_MERGE)
		internalExamples[CARDINALITY_MERGE_1] = [
		...
		internalExamples[CARDINALITY_MERGE_2] = [
					sourceSchema: "/testdata/cardmerge/t1.xsd",
					targetSchema: "/testdata/cardmerge/t2.xsd",
					alignment: "/testdata/cardmerge/t1t2.halex.alignment.xml",
		...
		internalExamples[SIMPLE_COMPLEX] = [
		...
		internalExamples[CARDINALITY_MOVE] = defaultExample(CARDINALITY_MOVE)

		// context matching examples
		internalExamples[CM_UNION_1] = defaultExample(CM_UNION_1)
		internalExamples[CM_UNION_2] = defaultExample(CM_UNION_2)
	}
