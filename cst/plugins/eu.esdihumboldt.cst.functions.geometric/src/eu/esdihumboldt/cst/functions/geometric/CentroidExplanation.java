 ...
 * @author Kevin Mais
 */
public class CentroidExplanation extends AbstractCellExplanation {
	...
	protected String getExplanation(Cell cell, boolean html, Locale locale) {
		...
		if (target != null && source != null) {
			String message = "Calculates the centroid of the geometry contained in the {1} property and assigns the result to the {0} property.";
