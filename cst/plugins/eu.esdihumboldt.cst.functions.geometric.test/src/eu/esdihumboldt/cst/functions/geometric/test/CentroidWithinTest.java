...
//	private static final Polygon XXX = factory.createPolygon(...);
	...
	public void testFootprint2() throws Exception {
		LinearRing outer = factory.createLinearRing(new Coordinate[] {
				new Coordinate(49.87517, 8.64862), new Coordinate(49.87491, 8.64873),
				new Coordinate(49.87497, 8.64913), new Coordinate(49.87521, 8.64904),
				new Coordinate(49.87525, 8.64924), new Coordinate(49.87424, 8.64958),
				new Coordinate(49.8742, 8.64937), new Coordinate(49.87446, 8.64929),
				new Coordinate(49.87441, 8.6489), new Coordinate(49.87414, 8.64897),
	...
	public void testFootprint2Hole() throws Exception {
		LinearRing outer = factory.createLinearRing(new Coordinate[] {
				...
				new Coordinate(49.87517, 8.64862) });
		LinearRing inner = factory.createLinearRing(new Coordinate[] {
				new Coordinate(49.87478, 8.6488), new Coordinate(49.87482, 8.64914),
	...
	public void testFootprint3() throws Exception {
		LinearRing outer = factory.createLinearRing(new Coordinate[] {
				new Coordinate(49.87494, 8.65267), new Coordinate(49.87488, 8.65277),
				new Coordinate(49.87461, 8.65286), new Coordinate(49.87451, 8.65274),
				new Coordinate(49.87449, 8.65256), new Coordinate(49.87457, 8.65225),
				new Coordinate(49.87483, 8.65217), new Coordinate(49.87494, 8.65229),
				new Coordinate(49.87488, 8.65249), new Coordinate(49.8748, 8.65242),
				new Coordinate(49.87471, 8.65244), new Coordinate(49.87466, 8.65252),
	...
	public void testStreetOuter() throws Exception {
		LinearRing outer = factory.createLinearRing(new Coordinate[] {
				new Coordinate(49.87274, 8.6547), new Coordinate(49.87275, 8.65473),
				new Coordinate(49.87269, 8.65477), new Coordinate(49.87261, 8.65486),
				new Coordinate(49.87257, 8.65489), new Coordinate(49.87247, 8.65506),
				new Coordinate(49.87241, 8.65525), new Coordinate(49.87234, 8.65536),
				new Coordinate(49.87241, 8.65536), new Coordinate(49.87247, 8.65539),
				new Coordinate(49.87248, 8.65542), new Coordinate(49.87282, 8.65532),
				new Coordinate(49.87281, 8.65536), new Coordinate(49.87248, 8.65546),
				new Coordinate(49.87245, 8.65557), new Coordinate(49.8724, 8.65561),
				new Coordinate(49.87235, 8.65562), new Coordinate(49.87228, 8.6556),
				new Coordinate(49.87223, 8.65558), new Coordinate(49.87218, 8.65554),
				new Coordinate(49.87206, 8.65558), new Coordinate(49.87205, 8.65556),
				new Coordinate(49.87219, 8.6555), new Coordinate(49.87229, 8.6554),
				new Coordinate(49.87235, 8.65529), new Coordinate(49.8724, 8.65521),
				new Coordinate(49.87244, 8.65509), new Coordinate(49.87252, 8.65494),
	...
	public void testHalfmoon() throws Exception {
		LinearRing outer = factory.createLinearRing(new Coordinate[] {
				new Coordinate(49.87359, 8.65558), new Coordinate(49.87307, 8.65649),
				new Coordinate(49.87239, 8.65812), new Coordinate(49.8724, 8.65586),
				new Coordinate(49.87294, 8.65431), new Coordinate(49.87402, 8.65378),
				new Coordinate(49.87541, 8.65358), new Coordinate(49.87671, 8.65437),
				new Coordinate(49.87751, 8.65659), new Coordinate(49.87683, 8.65548),
	...
	public void testHalfmoonThin() throws Exception {
		LinearRing outer = factory.createLinearRing(new Coordinate[] {
				new Coordinate(49.87343, 8.65491), new Coordinate(49.87285, 8.65592),
				new Coordinate(49.87239, 8.65812), new Coordinate(49.8724, 8.65586),
				new Coordinate(49.87294, 8.65431), new Coordinate(49.87402, 8.65378),
				new Coordinate(49.87541, 8.65358), new Coordinate(49.87671, 8.65437),
				new Coordinate(49.87751, 8.65659), new Coordinate(49.87683, 8.65548),
