...
public class EntityTypeConditionTest extends TestCase {
	...
	public void testTypeConditionForProperty(){
	   ...
	   // System.out.println("CST contains " + CstFunctionFactory.getInstance().getRegisteredFunctions().size() + "functions");
    	CstFunction f = null;
	    ...
	    for (Iterator<String> i = CstFunctionFactory.getInstance().getRegisteredFunctions().keySet().iterator(); i.hasNext();) {
            ...
            if (f != null){
            	...
            	catch(Exception e){ // only for Property type and ComposedProperty
            		entity1 = null;
            	}
            	// Setting of entity2
            	try{
            	...
            	if (entity1 != null){
            		try{
            			for (Iterator<String> it = entity1.getTypeCondition().iterator(); it.hasNext();){
            		...
            		// typeCondition doesn't exist for existing entity
            			...
            			System.out.println("---------------");
            			System.out.println(f.getClass().toString() + "-- missing typeCondition for entity1");
            			bug  = true;
            		}	
            	...
            	if (entity2 != null){
            		try{
            			for (Iterator<String> it = entity2.getTypeCondition().iterator(); it.hasNext();){
            				String tc = it.next();
            		...
            		// typeCondition class can't be created
            			...
            			System.out.println("---------------");
            			System.out.println(f.getClass().toString());
            			System.out.println(e + " --typeCondition for entity2  ");
            			bug = true;
            		}
            		// typeCondition doesn't exist for existing entity
            		catch(NullPointerException e){
            			System.out.println("---------------");
            			System.out.println(f.getClass().toString() + "-- missing typeCondition for entity2");
            			bug  = true;
            		}	
