...
/**
 * {@link CstFunction} to calculate the length of a given geometry.
 * 
 * @author Andreas Burchert
 * @partner 01 / Fraunhofer Institute for Computer Graphics Research
 * @version $Id$
 */
public class CalculateLength extends AbstractCstFunction {
	...
	public Feature transform(Feature source, Feature target) {
		...
		if (geom != null) {
			...
			FeatureInspector.setPropertyValue(target, targetProperty.getAbout(), length);
		}
