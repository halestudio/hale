...
import eu.esdihumboldt.mediator.context.Context;
import eu.esdihumboldt.mediator.context.impl.OrganizationContextImpl;
import eu.esdihumboldt.mediator.usermanagement.Organization;
import eu.esdihumboldt.mediator.usermanagement.OrganizationAddress;
import eu.esdihumboldt.mediator.usermanagement.User;
import eu.esdihumboldt.mediator.usermanagement.ValidatyDates;
 ...
 */
public abstract class OrganizationType implements java.io.Serializable, Organization {
	...
	throws java.lang.IndexOutOfBoundsException {
		...
		if (index < 0 || index >= this.contextList.size()) {
			throw new IndexOutOfBoundsException("getContext: Index value '" + index + "' not in range [0.." + (this.contextList.size() - 1) + "]");
		}
	 ...
	 * @throws java.lang.IndexOutOfBoundsException if the index
	 * given is outside the bounds of the collection
	 * @return the value of the OrganizationAddress
	 * at the given index
	 */
	...
	throws java.lang.IndexOutOfBoundsException {
		...
		if (index < 0 || index >= this.organizationAddressList.size()) {
			throw new IndexOutOfBoundsException("getOrganizationAddress: Index value '" + index + "' not in range [0.." + (this.organizationAddressList.size() - 1) + "]");
		}
	...
	/**
	 * Method getOrganizationAddress.Returns the contents of the
	 ...
	 * @throws java.lang.IndexOutOfBoundsException if the index
	 * given is outside the bounds of the collection
	 * @return the value of the User at the given
	 * index
	 */
	public User getUser(
			final int index)
	throws java.lang.IndexOutOfBoundsException {
		...
		if (index < 0 || index >= this.userList.size()) {
			throw new IndexOutOfBoundsException("getUser: Index value '" + index + "' not in range [0.." + (this.userList.size() - 1) + "]");
		}
	 ...
	 */
	public Context removeContextAt(
			final int index) {
	 ...
	 * @return the element removed from the collection
	 */
	public OrganizationAddress removeOrganizationAddressAt(
			final int index) {
	...
	private void setContextList(
			final List<Context> vContextList) {
	 ...
	 * 
	 * @param generalNotes the value of field 'generalNotes'.
	 */
	public void setGeneralNotes(
			final java.lang.String generalNotes) {
	 ...
	 * 
	 * @param nameLine1 the value of field 'nameLine1'.
	 */
	public void setNameLine1(
			final java.lang.String nameLine1) {
	 ...
	 * 
	 * @param nameLine2 the value of field 'nameLine2'.
	 */
	public void setNameLine2(
			final java.lang.String nameLine2) {
	 ...
	 * 
	 * @param nameLine3 the value of field 'nameLine3'.
	 */
	public void setNameLine3(
			final java.lang.String nameLine3) {
	 ...
	 * 
	 * @param organizationDisplayName the value of field
	 ...
	 * 
	 * @param organizationId the value of field 'organizationId'.
	 */
	public void setOrganizationID(
			final java.util.UUID organizationId) {
