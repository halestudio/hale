...
public class LogicalConstraintImpl
    ...
    /**
     * @param _constraints The List of Constraints to group together. The Constraints may be of any type implementing Constraint.
     * @param _operator The {@link LogicalOperator} that is used to bind the Constraints.
     */
    public LogicalConstraintImpl(List<Constraint> _constraints, LogicalOperator _operator) {
        this.uid = IdentifierManager.next();
    ...
    /**
     * Simple constructor for the binding of two Constraints. Doesn't require a list.
     * @param _a the first {@link Constraint}
     * @param _b the second {@link Constraint}
     * @param _operator the {@link LogicalOperator} that is used to bind the Constraints.
     */
    public LogicalConstraintImpl(Constraint _a, Constraint _b, LogicalOperator _operator) {
        this.uid = IdentifierManager.next();
        this.constraints = new ArrayList<Constraint>();
    ...
    /**
     * This operation returns a copy of the list of Constraints bound to
     * this logical constraint.
     * @see eu.esdihumboldt.mediator.constraints.LogicalConstraint#getBoundConstraints()
     */
    ...
    /**
     * @see eu.esdihumboldt.mediator.constraints.LogicalConstraint#getLogicalOperator()
     */
    ...
    public boolean isSatisfied() {
        ...
        if (this.operator == LogicalOperator.EQUALS) {
            if ((true_counter == this.constraints.size()) || (true_counter == 0)) {
                return this.status = true;
            }
        }
        return this.status;
