...
public class LanguageType implements java.io.Serializable {
    ...
    /**
     * Method valueOf.Returns a new LanguageType based on the given
     * String value.
     * 
     * @param string
     * @return the LanguageType value of parameter 'string'
     */
    public static eu.esdihumboldt.mediator.usermanagement.types.impl.LanguageType valueOf(
