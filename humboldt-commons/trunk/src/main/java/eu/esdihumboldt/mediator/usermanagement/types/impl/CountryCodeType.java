...
public class CountryCodeType implements java.io.Serializable
 {
    ...
    /**
     * Method valueOf.Returns a new CountryCodeType based on the
     * given String value.
     * 
     * @param string
     * @return the CountryCodeType value of parameter 'string'
     */
    public static eu.esdihumboldt.mediator.usermanagement.types.impl.CountryCodeType valueOf(
