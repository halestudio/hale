...
//		this.satisfied = true;
    ...
    /**
     * @param _envelope the Envelope being used as a query area.
    ...
    /**
     * @see eu.esdihumboldt.mediator.constraints.SpatialConstraint#getGeometry()
     */
    ...
    /**
     * @see eu.esdihumboldt.mediator.constraints.SpatialConstraint#getRelationType()
     */
    ...
    /**
     * @param dbEnvelope the dbEnvelope to set
     */
