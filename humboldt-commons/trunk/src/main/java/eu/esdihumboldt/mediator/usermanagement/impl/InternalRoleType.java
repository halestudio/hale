...
import eu.esdihumboldt.mediator.usermanagement.Role;

/**
 * This Type represents the role that the actual user has
 *  within the HUMBOLDT system, not his role to the outside
 *  world. It is therefore only of concern when internal
