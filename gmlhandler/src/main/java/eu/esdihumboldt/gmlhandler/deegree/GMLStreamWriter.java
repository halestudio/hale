 ...
 * </p>
 * 
 * Version of GMLStreamWriter that uses a custom {@link GMLFeatureWriter} with 
 * support for {@link InternalFeature}s (the only thing changed is the removed
 * import for GMLFeatureWriter and the public constructor)
 * 
 * @see GMLObject
