 ...
 * elements than those which have explicit constraint types, such as 
 * responsible party or a certain identification such as keywords.
 * 
...
public interface MetadataConstraint extends Constraint {
	 ...
	 * property that needs to be in this.getRelationType() to the property of a 
	 * dataset to sue.
	 */
	...
	public enum MetadataType {
		...
		Extension,
		ResponsibleParty,
		LegalAccessUseConstraint,
		SecurityAccessUseConstraint,
		Keywords,
		Identification,
		Series
	}
