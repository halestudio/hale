...
public interface Context {
	...
	/**
	 * @param 
	 * 		type the ContextType whose constraints shall be returned.
	 * @return the Set of Constraints defined for the given ContextType. This 
	 * operation will return just the constriants of that level and not take 
	 * into account overwriting or additional constraints defined at other 
	 * levels.
	 */
	...
	/**
	 * @param type 
	 * 		type the ContextType whose combined constraints shall be returned.
	 * @return a Set of Constraints that has been created by combining the
	 * subsets of Constraints. This combination is done to the specified scope,
	 * i.e. if type = Organisation, Default and Organisation Constraints will
	 * be combined. For the combination, Organisation Constraints can overwrite
	 * Default Constraints, and User Constriants can overwrite Organisation 
	 * Constraints, except when a Constraint is declared final.
	 */
	...
	public enum ContextType {
		...
		/**
		 * Organization Context includes link to Default Context as a parent context and organization-owner of this context. 
		 */
		Organisation,
		
		/**
		 * Organization Context includes link to Organization Context as a parent context and user-owner of this context. 
		 */
