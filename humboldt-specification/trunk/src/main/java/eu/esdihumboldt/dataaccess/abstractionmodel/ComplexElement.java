...
public interface ComplexElement 
	 ...
	 * in turn be {@link ComplexElement} objects) that are a child of this 
	 * {@link ComplexElement}. By using this structure, trees (unidirectional
	 * acyclic graphs) may be built.
	 */
