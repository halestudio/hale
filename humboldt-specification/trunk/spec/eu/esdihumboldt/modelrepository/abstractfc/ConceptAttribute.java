 ...
 * to ISO 19110 FC_FeatureAttribute.
 * 
...
public interface ConceptAttribute 
	 ...
	 * ConceptAttribute uses. Examples are m, kg, s, A, K, mol or cd. This
	 * method may return null in case of unitless values.
	 */
	public String getUnitOfMeasure();
	
	/**
	 * Equal to ISO 19110 FC_FeatureAttribute.listedValue.
	 * @return an Enumeration of allowed values for this ConceptAttribute.
	 * This operation may return <code>null</code>, in which case the values 
	 * range is unbounded.
	 */
	 ...
	 * {@link URI}. Where possible, the type codes from XML Schema have to 
	 * be used, such as xsd:string, xsd:decimal or xsd:date. 
	 */
