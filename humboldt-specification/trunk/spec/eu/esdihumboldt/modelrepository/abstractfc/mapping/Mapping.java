 ...
 */
package eu.esdihumboldt.modelrepository.abstractfc.mapping;
...
public interface Mapping 
	...
	/**
	 * @return true if the provided {@link Mapping} can be used to transform 
	 * not only from source to target but also vice versa.
	 */
