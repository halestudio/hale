 ...
 * {@link Concept} is a certain FeatureType. The modeling of this {@link Concept} consequently 
 * follows the notion of a FeatureType as described in ISO 19110 (Feature 
 * Catalogues).
 * 
...
public interface Concept 
	...
	/**
	 * Identical to ISO 19110 FC_FeatureType.typeName, except that currently 
	 * no Localization is supported. TODO: This will be added later, with an 
	...
	/**
	 * This operation includes ISO 19110 FC_FeatureType.inheritsFrom, 
	 * and FC_FeatureType.inheritsTo. FC_InheritanceRelation is thus a subclass 
	 * of Relation. 
	 * 
	 * @return a Set of Relation objects that describe how this concept is 
	 * related to other concepts in the same ConceptualSchema or in other 
	 * InformationModels.
	 */
	 ...
	 * @return a Set of ConceptProperty objects defining the characteristics of this 
	 * Concept.
	 */
