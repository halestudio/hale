...
public interface ConceptProperty {
	...
	/**
	 * This interface describes the cardinality of a property. Note that for
	 * a full relation, two cardinalities are required.
	 */
	 ...
	 * @return the local name of the ConceptProperty, i.e. unique to the Concept that
	 * this ConceptProperty belongs to.
	 */
	 ...
	 * ConceptProperty. 1/1 will translate to a simple attribute or operation, 0..* to
	 * a Collection. 
	 */
