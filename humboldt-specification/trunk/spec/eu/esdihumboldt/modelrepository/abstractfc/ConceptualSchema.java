 ...
 * Concepts, Relationships and Transitions (i.e. Actions that allow to use 
 * otherwise unrelated concepts). Transitions are being used by the 
 * RequestBroker to decide which Transformers will need to be applied to a
 * data set to satisfy a client's constraints.
 * 
 ...
 * @version $Id$ 
 */
public interface ConceptualSchema 
	 ...
	 * TODO: Should be formalized.
	 */
	public Set<String> getApplicationFields();
	
	/**
	 * @return if this ConceptualSchema is a profile/specialization of another,
	 * more generic profile, then this operation returns that information model's
	 * Citation, including the name and other Identifiers.
	 */
	public Citation getParentInformationModel();
	
	/**
	 * @return a Set of all Concepts belonging to this ConceptualSchema. 
	 * Relations and Transitions are returned implicitly but not as first-row
	 ...
	 * ISO19115 including things like a name and identifier (both required).
	 */
