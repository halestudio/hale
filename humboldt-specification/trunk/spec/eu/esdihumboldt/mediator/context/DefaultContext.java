...
import eu.esdihumboldt.mediator.constraints.QualityConstraint;
import eu.esdihumboldt.mediator.constraints.ResolutionConstraint;
import eu.esdihumboldt.mediator.constraints.SpatialConstraint;
import eu.esdihumboldt.mediator.constraints.TemporalConstraint;
import eu.esdihumboldt.mediator.constraints.ThematicConstraint;


/**
 * A DefaultContext Interface allows access to default details
 * like:
 * <ul>
...
public interface DefaultContext extends Context {
	 ...
	 * 
	 * 
	 * @return Returns Default Thematic Constraint, if
	 * User or Organization Thematic Constraint 
	 * is not specified.   
	 */
	...
	/**
	 * 
	 * @return Returns Default Language Constraint, if
	 * User Language Constraint is not specified.
	 */
	public LanguageConstraint getLanguageConstraint();

	/**
	 * 
	 * @return Returns Default Quality Constraint, if
	 * User or Organization Quality Constraint is not 
	 * specified.   
	 * 
	 */
	...
	/**
	 * 
	 * @return Returns Default Temporal Constraint, if
	 * User or Organization Temporal Constraint  
	 * is not specified.   
	 * 
	 */
	...
	/**
	 * 
	 * @return Returns Default Spatial Constraint, if
	 * User or Organization Spatial Constraint  
	 * is not specified.   
	 * 
	 */
	...
	/**
	 * 
	 * @return Returns Default Portrayal Constraint, if
	 * User or Organization Portrayal Constraint  
	 * is not specified.   
	 * 
	 */
	...
	/**
	 * 
	 * @return Returns Default Resolution  Constraint, if
	 * User or Organization Resolution Constraint  
	 * is not specified.   
	 * 
	 */
	...
	/**
	 * 
	 * @return  Default Metadata constraint, 
	 * if User or Organization Metadata Constraint 
	 * is not specified.
	 * 
	 */
