...
public interface RequestBroker {
	...
	/**
	 * @param request the MediatorComplexRequest created from the client request
	 * and the ContextService context.
	 ...
	 * has been set up.
	 * @param ares the completed AccessResponse.
	 */
	 ...
	 * @param hres the MediatorResponse that contains the end result of 
	 * the Transformation. 
	 */
