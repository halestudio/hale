...
* Purpose: This exception is thrown when an unspecified error in {@link GroundingCatalogueRepository} occurs.<br/>   
*    
...
public class GroundingCatalogueRepositoryException extends Exception{
	 ...
	 * @param _root - The root cause of this Exception.
	 */
	public GroundingCatalogueRepositoryException(java.lang.String _description,java.lang.Throwable _root){
