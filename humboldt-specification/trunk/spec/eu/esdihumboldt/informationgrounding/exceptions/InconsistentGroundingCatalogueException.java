...
* Purpose: This exception is thrown when the {@link GroundingCatalogue} is not valid.<br/>   
*    
...
public class InconsistentGroundingCatalogueException extends Exception {
	 ...
	 * @param _root - The root cause of this Exception.
	 */
	public InconsistentGroundingCatalogueException(java.lang.String _description,java.lang.Throwable _root){
