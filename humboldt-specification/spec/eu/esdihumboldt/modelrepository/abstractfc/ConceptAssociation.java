...
import eu.esdihumboldt.modelrepository.abstractfc.ConceptAssociation;
 ...
 * by another {@link Concept} in the same {@link ConceptualSchema}. It is
 * primarily used to describe Aggregations and Compositions.
 * 
 ...
 * @version $Id$ 
 */
public interface ConceptAssociation 
	 ...
	 * {@link Concept} that can act in this role relative to a single instance 
	 * of the target {@link Concept} type of the ConceptAssociation.
	 */
	 ...
	 * @return true if the concept instances that this {@link ConceptAssociation} 
	 * refers to have to be ordered.
	 */
