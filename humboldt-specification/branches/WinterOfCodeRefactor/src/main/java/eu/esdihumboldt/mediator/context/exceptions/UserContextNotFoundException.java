...
/**
*    
* This exception is thrown when a UserContext with the given idenitifier does not exist.<br/>   
*    
...
public class UserContextNotFoundException extends Exception {
	 ...
	 * @param _root - The root cause of this Exception.
	 */
	public UserContextNotFoundException(java.lang.String _description,java.lang.Throwable _root){
