...
/**
 * A UserAddress  contains a user-specific specified address within an Organization. 
 * Organization address can be referenced as an option.Personal addresses that do not exist as 
 * corporate addresses will not be stored. Any address that is associated with a user is also 
 * a corporate address.
 * 
...
public interface UserAddress extends Address {
	...
	/**
	 * 
	 * A CommunicationDetail is the information of the 
	 * communication detail for the person.
	 *
	 */
	public enum CommunicationDetail{
		/** Contains a description of the communication detail for the person, e.g. telephone number. */
		...
		CommunicationValue,
		/**A flag to provide information on whether this is the default communication method. */
