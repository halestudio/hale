 ...
 */
public class FilterToXPath implements ExpressionVisitor, FilterVisitor {
...
//        else {
	...
	public Object visit(PropertyName expression, Object buffer) {
		...
		List<List<QName>> paths = PropertyResolver.getFullPaths(definition, DataSet.SOURCE, path);
