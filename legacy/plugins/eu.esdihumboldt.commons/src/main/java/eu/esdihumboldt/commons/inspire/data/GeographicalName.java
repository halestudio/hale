...
public class GeographicalName {
	...
	public boolean equals(GeographicalName target) {
		...
		if (nativeness != null
				&& nativeness.equals(target.getNativeness()) == false)
			return false;
		else if (nativeness == null && target.getNativeness() != null)
			return false;

		if (nameStatus != null
				&& nameStatus.equals(target.getNameStatus()) == false)
			return false;
		else if (nameStatus == null && target.getNameStatus() != null)
			return false;

		if (sourceOfName != null
				&& sourceOfName.equals(target.getSourceOfName()) == false)
			return false;
		...
		if (grammaticalGender != null
			...
			return false;
		else if (grammaticalGender == null
				&& target.getGrammaticalGender() != null)
			return false;

		if (grammaticalNumber != null
				&& grammaticalNumber.equals(target.getGrammaticalNumber()) == false)
			return false;
		else if (grammaticalNumber == null
				&& target.getGrammaticalNumber() != null)
			return false;
