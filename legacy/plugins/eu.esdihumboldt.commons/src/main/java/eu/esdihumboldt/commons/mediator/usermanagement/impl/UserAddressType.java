 ...
 */
public abstract class UserAddressType extends eu.esdihumboldt.commons.mediator.usermanagement.impl.AddressType 
implements java.io.Serializable, UserAddress
{
    ...
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (eu.esdihumboldt.commons.mediator.usermanagement.impl.CommunicationDetailsImpl) communicationDetailsList.get(index);
    }
    ...
    public eu.esdihumboldt.commons.mediator.usermanagement.impl.CommunicationDetailsImpl[] getCommunicationDetails(
        ...
        return (eu.esdihumboldt.commons.mediator.usermanagement.impl.CommunicationDetailsImpl[]) this.communicationDetailsList.toArray(array);
    }
