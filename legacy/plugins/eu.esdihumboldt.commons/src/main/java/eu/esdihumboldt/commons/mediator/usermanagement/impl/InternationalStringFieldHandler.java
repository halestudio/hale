...
public class InternationalStringFieldHandler extends GeneralizedFieldHandler {
     ...
     *
     * @param should be an InternationalString object
     * @return String representation of the InternationalString
     */
	@Override
	public Object convertUponGet(Object is) {
		//A simple international string consists of a single string for all locales.
		//This methods uses the en-locale, to get the StringRepresentation of this object.
		return (is == null) ? null :((SimpleInternationalString) is).toString(new Locale("en"));
	}
     ...
     * set for the field.
     *
     * @param String representation of InterantionalString
     * @return a org.geotools.util.SimpleInternationalString 
     */
	@Override
	public Object convertUponSet(Object stringIS) {
		return (stringIS == null)? null :new SimpleInternationalString((String) stringIS);
	}
