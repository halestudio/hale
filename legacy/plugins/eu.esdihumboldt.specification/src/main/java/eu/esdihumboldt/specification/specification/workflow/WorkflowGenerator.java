 ...
 * This interface has got one method that ecapsulates this functionality. 
...
public interface WorkflowGenerator {
    ...
    /**This is the main operation called by the Mediator to retrieve a workflow. The retrieved
     * Workflow is a Mediator workflow Model and is different from the Internal Workflow Service
     * Basic Workflow. In this method, the design time preconditions are concretized and groundings
     * for the construction time preconditions are retrieved. in addition, any  required transformers 
     * are also plugged into the BW. The resulting valid basic workflow is then used to generate a
