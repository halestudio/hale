 ...
 *          Exp $
 */
public class ConstraintTypeComparator implements Comparator<Object> {
	...
	public int compare(Object _constraint1, Object _constraint2) {
		...
		List<Class<?>> c1_supertypes = this.getSupertypes(_constraint1
				.getClass());
		List<Class<?>> c2_supertypes = this.getSupertypes(_constraint2
				.getClass());
