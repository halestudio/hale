...
public class CellSyncAction extends Action implements ISelectionListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection selection) {
		if (isChecked() && selection instanceof IStructuredSelection && !selection.isEmpty()
			...
			sourceExplorer.getTreeViewer().setSelection(createSelection(cell.getSource().values()),
					true);
			targetExplorer.getTreeViewer().setSelection(createSelection(cell.getTarget().values()),
					true);
		}
	}
