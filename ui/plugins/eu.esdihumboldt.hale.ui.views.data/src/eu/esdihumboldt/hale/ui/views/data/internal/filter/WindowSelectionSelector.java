...
public class WindowSelectionSelector implements InstanceSelector {
	...
	private class InstanceSelectorControl extends Composite implements ISelectionListener {
		...
		private Collection<Instance> getSelectedInstances(TypeDefinition typeFilter) {
			if (lastSelection == null || lastSelection.isEmpty() || !(lastSelection instanceof InstanceSelection)) {
				...
				//FIXME need to differentiate between source and transformed instances!
				
				// collect instances from selection
	...
	private final SchemaSpaceID schema;
	 ...
	 */
	public WindowSelectionSelector(SchemaSpaceID schema) {
		this.schema = schema;
	}
