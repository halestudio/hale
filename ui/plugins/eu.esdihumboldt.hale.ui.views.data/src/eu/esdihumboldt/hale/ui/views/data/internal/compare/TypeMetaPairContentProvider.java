...
/**
 * Subclass of the tree content provider {@link TypeIndexContentProvider}, 
 * which can handle metadatas of instances
...
public class TypeMetaPairContentProvider extends TypeIndexContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		else return super.getChildren(parentElement);
	}
	...
	public boolean hasChildren(Object parentElement) {
		...
		else return super.hasChildren(parentElement);
	}
