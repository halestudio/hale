...
import eu.esdihumboldt.hale.ui.common.definition.viewer.HelperFunctionLabelProvider;
import eu.esdihumboldt.hale.ui.common.function.viewer.HelperFunctionContentProvider;
...
public class PageFunctions extends DialogTray implements GroovyConstants {
	...
	public static void createToolItem(ToolBar toolbar, final HaleWizardPage<?> page) {
		...
		item.addSelectionListener(new SelectionListener() {
			...
			public void widgetDefaultSelected(SelectionEvent e) {
				page.setTitle("show functions by default");
	...
	protected Control createContents(Composite parent) {
		...
		HelperFunctionLabelProvider labelProvider = new HelperFunctionLabelProvider(tree);
