	...
	public void createViewControl(Composite parent) {
		...
		sourceTargetSelector.getControl().setLayoutData(
				GridDataFactory.swtDefaults().align(SWT.FILL, SWT.CENTER).grab(true, false)
						.create());
		final ISelectionChangedListener changeListener = new ISelectionChangedListener() {
		...
		sourceTargetSelector.addSelectionChangedListener(changeListener, SchemaSpaceID.SOURCE);
		sourceTargetSelector.addSelectionChangedListener(changeListener, SchemaSpaceID.TARGET);
...
//				typeRelations.setSelection(new StructuredSelection(cell));
				sourceTargetSelector.setSelection(cell);
				return;
			}
		}
