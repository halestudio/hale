...
public class MathEditor extends AbstractEditor<String> {
	...
	private final PropertyEntityDefinition[] variables = new PropertyEntityDefinition[0];
	 ...
	 */
	public MathEditor(Composite parent, final Script script) {
		this.script = script;
		...
		textField.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				...
				String result = script.validate(currentValue, createPropertyValues());
		...
		varTable.setLabelProvider(new DefinitionLabelProvider(true, true) {
			...
			public String getText(Object element) {
				return script.getVariableName((PropertyEntityDefinition) element);
			}
		});
	...
	protected Iterable<PropertyValue> createPropertyValues() {
		Collection<PropertyValue> result = new ArrayList<PropertyValue>(variables.length);
