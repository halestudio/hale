...
//		this.newlocation = newLocation;
		...
		newfolder = analysePaths(oldLocation, newLocation).toString();
	}
	...
	protected String changePath(URI oldsource) {
		...
		String[] subfolder = setSubFolder(oldLocation, oldsource);
		String[] parentfolder = setParentFolder(oldLocation, oldsource);
		if(subfolder != null){
...
//	}
	...
	private String[] setSubFolder(URI project, URI file){
	...
	private String[] setParentFolder(URI project, URI file){
		String pct = project.getPath().substring(1);
		pct = pct.substring(0, pct.lastIndexOf("/"));
		String[] pctarray = pct.split("/");
		String fle = file.getPath().substring(1);
