...
public class ViewerEntityTray extends DialogTray {
	...
	protected Control createContents(Composite parent) {
		...
		label.setText("An entity that is referenced in a mapping cell cannot be resolved. This may be due to a changed schema, with for instance changed namespaces or property names. To update the cell please select a replacement entity to the left - a reconstruction of the original entity is sketched below:");
