...
public class SchemaPatternFilter extends TreePathPatternFilter {
	 ...
	 * The default behavior checks that the label of the element is a match with the filter text. Subclasses should override this method.<br>
	 * <br>
	 * Subclasses which add additional criteria should disable early termination ({@link TreePathPatternFilter#setUseEarlyReturnIfMatcherIsNull(boolean)}).
	 * 
	...
	/**
	 * @see eu.esdihumboldt.hale.ui.util.viewer.tree.TreePathPatternFilter#isLeafMatch(org.eclipse.jface.viewers.Viewer, java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see eu.esdihumboldt.hale.ui.util.viewer.tree.TreePathPatternFilter#isElementVisible(org.eclipse.jface.viewers.Viewer, java.lang.Object)
	 */
	@Override
