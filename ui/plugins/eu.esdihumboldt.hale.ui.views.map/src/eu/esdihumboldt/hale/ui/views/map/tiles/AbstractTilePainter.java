 ...
 */
package eu.esdihumboldt.hale.ui.views.map.tiles;
...
import eu.esdihumboldt.hale.ui.views.map.tiles.TileCache.TileListener;
...
public abstract class AbstractTilePainter implements PaintListener,
	...
	private static final ALogger log = ALoggerFactory.getLogger(AbstractTilePainter.class);
	...
	/**
	 * Update the map without an area update
	 */
...
//			System.out.println("zoom = " + zoom + " x = " + x + ", y = " + y + " : " + result.toString());
	...
	public IAction getZoomInAction() {
		...
		action.setImageDescriptor(MapViewPlugin.getImageDescriptor(
	 ...
	 * @param x the x pixel ordinate
	 * @param y the y pixel ordinate
	 ...
	 * 
	 * @param x the canvas x pixel ordinate
	 * @param y the canvas y pixel ordinate
	 * 
	 ...
	 * 
	 * @param tileX the tile pixel x ordinate
	 * @param tileY the tile pixel y ordinate
