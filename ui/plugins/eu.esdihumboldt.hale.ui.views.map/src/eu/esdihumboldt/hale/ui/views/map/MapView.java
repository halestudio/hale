...
import eu.esdihumboldt.hale.ui.style.LoadStylesAction;
...
public class MapView extends ViewPart {
	 ...
	 * The view ID
	 */
	public static final String ID = "eu.esdihumboldt.hale.ui.views.map"; //$NON-NLS-1$
	...
	public void createPartControl(Composite _parent) {
		...
		if (invertImage == null) {
			invertImage = MapViewPlugin.getImageDescriptor("icons/invert.gif").createImage(); //$NON-NLS-1$
		}
