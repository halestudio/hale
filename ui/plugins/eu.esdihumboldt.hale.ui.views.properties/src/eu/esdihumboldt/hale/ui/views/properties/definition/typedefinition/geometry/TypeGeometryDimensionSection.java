...
/**
 * Property type geometry dimension from {@link GeometryMetadata}.
 * 
 * @author Simon Templer
 */
public class TypeGeometryDimensionSection extends AbstractSimpleTextSection {
	...
	protected void updateControl(Object input, Text control) {
		...
		if (gm.getDimension() != 0) {
			control.setText(String.valueOf(gm.getDimension()));
		}
		else {
			control.setText("Unknown");
		}
	}
