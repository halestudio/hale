...
/**
 * Abstract function section with function name
 * 
 * @author Patrick Lieb
 */
public class AbstractFunctionNameSection extends DefaultFunctionSection<FunctionDefinition<?>> {
	...
	@Override
	public void refresh() {
		name.setText(getFunction().getDisplayName());
	}
}
