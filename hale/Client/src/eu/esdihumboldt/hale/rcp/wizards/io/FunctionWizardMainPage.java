...
import eu.esdihumboldt.hale.models.impl.SchemaServiceEnum;
	...
	/**
	 * This is the first page of the {@link FunctionWizard}. It allows to
	 * select the principal wizard for the transformation to be used in HALE.
	 * 
	 * @author Thorsten Reitz
	 * @version $Id$
	 */
	public class FunctionWizardMainPage 
		extends WizardPage {
		
		private static Logger _log = Logger.getLogger(FunctionWizardMainPage.class);
		...
		protected FunctionWizardMainPage(String pageName, String pageTitle) {
			super(pageName, pageTitle, (ImageDescriptor) null); // FIXME ImageDescriptor
			super.setTitle(pageName); //NON-NLS-1
			super.setDescription("Select a wizarsType");
		}
