...
/**
 * Factory for {@link NetworkGeneralizationFunctionWizard}s
 * 
 * @author Simon Templer
 * @partner 01 / Fraunhofer Institute for Computer Graphics Research
 * @version $Id$ 
 */
public class NetworkGeneralizationFunctionWizardFactory implements FunctionWizardFactory {
	...
	public FunctionWizard createWizard(CellSelection cellSelection) {
		return new NetworkGeneralizationFunctionWizard(cellSelection);
	}
	...
	public FunctionWizard createWizard(SchemaSelection schemaSelection,
		...
		return new NetworkGeneralizationFunctionWizard(schemaSelection,
				alignmentService);
	}
