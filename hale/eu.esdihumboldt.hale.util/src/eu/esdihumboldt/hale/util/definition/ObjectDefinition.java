...
package eu.esdihumboldt.hale.util.definition;
...
public interface ObjectDefinition<T> {
	 ...
	 * The identifier must be unique for object factories that have compatible
	 * supported types. It is used to associate a definition string to the 
	 * factory.
	 * The identifier may not contain a <code>:</code>
	...
	/**
	 * Represent the given object as a definition string, so that it 
	 * can be used to again create an object instance using 
	 * {@link #parse(String)}.
	 *   
