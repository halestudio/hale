...
public class TileCache implements TileProvider {
	...
	private static final ALogger log = ALoggerFactory.getLogger(TileCache.class);
	...
	/**
	 * Draw a loading image. A part of the parent image will be used for this
	 * 
	 * @param img the parent image
	 * @param constraints the tile constraints
	 * @param partX the x ordinate of the part
	 * @param partY the y ordinate of the part
	 * @param partWidth the part width
	 * @param partHeight the part height
	 * 
	...
	private ImageData drawLoadingImage(ImageData img, TileConstraints constraints,
		...
		try {
			...
			try {
				...
				log.debug("Error drawing loading image", e); //$NON-NLS-1$
			}
