 ...
 * @since 2.1.M3
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.4/modules/library/main/src/main/java/org/geotools/feature/FeatureTypes.java $
 */
public class FeatureTypes {
    ...
    public static List<FeatureType> getAncestors(FeatureType featureType) {
        ...
        AttributeType type = featureType; //XXX ST - use AttributeType for traversal
        while (type.getSuper() != null) {
            ...
            type = type.getSuper(); //XXX ST - always step up
        }
        return ancestors;
    }
