...
package eu.esdihumboldt.hale.rcp.utils.codelist;
...
public interface CodeListService {
	 ...
	 * 
	 * @param attributeIdentifier the attribute identifier
	 * @param codeList the code list to assign or <code>null</code> with the 
	...
	/**
	 * Get the search path code lists
	 * 
	 * @return the search path code lists
	 */
