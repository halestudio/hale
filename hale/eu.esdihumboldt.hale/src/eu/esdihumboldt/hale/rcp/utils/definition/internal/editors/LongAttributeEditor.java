 ...
 * @version $Id$ 
 */
public class LongAttributeEditor extends StringValidatingAttributeEditor<Long> {

	/**
	 * @see StringValidatingAttributeEditor#StringValidatingAttributeEditor(Composite)
	 */
	public LongAttributeEditor(Composite parent) {
		super(parent);
	}
	 ...
	 */
	@Override
	protected String stringFromValue(Long value) {
