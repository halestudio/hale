...
public class WKTPreferencesCRSFactory extends AbstractFactory implements CRSAuthorityFactory {
	...
	private static final Logger _log = Logger.getLogger(WKTPreferencesCRSFactory.class);
     ...
     * Preferences node
     */
    private Preferences node = Preferences.userNodeForPackage(WKTPreferencesCRSFactory.class).node(AUTHORITY);
