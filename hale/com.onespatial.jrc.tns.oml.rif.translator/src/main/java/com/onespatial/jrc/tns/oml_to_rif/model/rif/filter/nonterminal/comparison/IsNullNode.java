...
/**
 * A node within a predicate tree that expresses an "is null" comparison (tests
 * whether an attribute does not exist.
 * 
 * @author Susanne Reinwarth / TU Dresden
 *
 */
public class IsNullNode extends AbstractComparisonNode {

	/**
     * Set as protected in case this class is extended.
     */
	protected NodeType nodeType = NodeType.IS_NULL_NODE;
