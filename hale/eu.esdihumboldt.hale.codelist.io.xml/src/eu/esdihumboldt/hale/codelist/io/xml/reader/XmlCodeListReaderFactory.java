...
public class XmlCodeListReaderFactory extends AbstractIOProviderFactory<CodeListReader>
	...
	/**
	 * @see eu.esdihumboldt.hale.core.io.IOProviderFactory#getIdentifier()
	 */
	@Override
	...
	/**
	 * @see eu.esdihumboldt.hale.core.io.IOProviderFactory#getDisplayName()
	 */
	@Override
	...
	/**
	 * @see eu.esdihumboldt.hale.core.io.IOProviderFactory#getSupportedTypes()
	 */
	@Override
	...
	/**
	 * @see eu.esdihumboldt.hale.core.io.IOProviderFactory#createProvider()
	 */
	@Override
