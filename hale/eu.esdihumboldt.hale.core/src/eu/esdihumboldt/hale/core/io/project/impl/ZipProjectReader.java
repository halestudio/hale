...
package eu.esdihumboldt.hale.core.io.project.impl;
...
import eu.esdihumboldt.hale.core.io.project.ProjectIO;
...
import eu.esdihumboldt.hale.core.io.util.InputStreamDecorator;
...
public class ZipProjectReader extends AbstractImportProvider implements ProjectReader {
	...
	/**
	 * @see eu.esdihumboldt.hale.core.io.project.ProjectReader#getProjectFiles()
	 */
	@Override
	...
	/**
	 * @see eu.esdihumboldt.hale.core.io.project.ProjectReader#getProject()
	 */
	@Override
