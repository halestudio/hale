...
public abstract class GMLGeometryUtil {
	...
	public static Coordinate parseCoord(Instance instance) throws GeometryNotSupportedException {
		...
		Collection<Object> values = PropertyResolver.getValues(instance, "X");
