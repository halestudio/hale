package eu.esdihumboldt.hale.io.oml.internal.util;
...
public class XMLHandler {
	...
	public Object unmarshall(String xmlRequestString) {
		ByteArrayInputStream is = new ByteArrayInputStream(xmlRequestString.getBytes());
	...
	public String marshall(Object object, String localPart) {
		...
		// marshal to string
		try {
			marshaller.marshal(new JAXBElement(new QName("uri", localPart), object.getClass(),
					object), writer);
		} catch (JAXBException exception) {
			exception.printStackTrace();
		}
	...
	public Object unmarshallRequest(InputStream is) {
		...
		try {
			...
			message = ((JAXBElement) object).getValue();
