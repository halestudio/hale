...
public class CSVInstanceWriterTest {
	...
	public void testWriteSimpleSchema() throws Exception {
		...
		// eu.esdihumboldt.cst.test/src/testdata/simpleassign/t1.xsd
		String propertyNames = "a1,b1,c1";
		String firstDataRow = "a10,,c10";
		// header size
		...
		assertEquals("Not enough columns.", numberOfColumns, countCols);
