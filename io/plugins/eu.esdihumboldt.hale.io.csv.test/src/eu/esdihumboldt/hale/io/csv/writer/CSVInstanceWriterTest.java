...
public class CSVInstanceWriterTest {
	 ...
	 * order of column persisted from original schema
	 * 
	 * @throws Exception , if an error occurs
	 */
	@Test
	public void testWriteSimpleSchemaColOrder() throws Exception {
		...
		// TODO: add extra unit test for the case of an empty instance
		/*
		 * Schema schema = new SchemaBuilder().schema { city { name(String),
		 * population(Integer), location(GeometryProperty), } };
		 */
