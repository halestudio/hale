...
/**
 * An extension of {@link JDBCSchemaReader} for MsSQL Server Database
 * 
 * @author Arun
 */
public class MsSqlSchemaReader extends JDBCSchemaReader {

	private static final ALogger log = ALoggerFactory.getLogger(MsSqlSchemaReader.class);
