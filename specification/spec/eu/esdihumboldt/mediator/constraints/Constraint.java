 ...
 * the user regarding a specific request that user made to the system. 
 * There are several different sources for a constraint:
 * <ul>
 ...
 * which transformation need to be applied to a data set before returning it
 * to the client.
 * 
...
parameter,
/** Information that is gathered from the protocol layer of the
 * request. This contains things like the HTTP_env variables. */
protocol,
/** Information retrieved from the Request's context, usually
...
/**This method checks to see if a certain constraint can be overwritten
 * or not during precondition concretization
