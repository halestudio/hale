...
/**
*    
* This exception is thrown when an OrganizationContext with the given idenitifier does not exist.<br/>   
*    
...
public class OrganizationContextNotFoundException extends Exception {
	 ...
	 * @param _root - The root cause of this Exception.
	 */
	public OrganizationContextNotFoundException(java.lang.String _description,java.lang.Throwable _root){
