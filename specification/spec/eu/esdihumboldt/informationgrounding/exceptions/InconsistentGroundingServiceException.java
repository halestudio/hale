...
* Purpose: This exception is thrown when the Grounding Service 
* is not valid.<br/>   
*    
...
public class InconsistentGroundingServiceException extends Exception {
	 ...
	 * @param _root - The root cause of this Exception.
	 */
	public InconsistentGroundingServiceException(java.lang.String _description,java.lang.Throwable _root){
