 ...
 * 
 * For Use Cases, use the following syntax:
 * <i>Use Case Identifier.Step</i>
 * Example: <i>UC0001.2</i>
 * If you are referring to an alternative process, follow this syntax:
 * <i>Use Case Identifier.Process Identifier.Step</i>
 * Example: <i>UC0001.AP01.1</i>
 * 
 * If there are multiple sources requiring this operation, you can use this
 * syntax:
 * Example <i>("UC0001.AP01.1, UC0002.2, ...")</i>
 * 
